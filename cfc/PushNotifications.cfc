...
<cfcomponent>
	...
	<cfset variables.datasource = "voterdb" />
	...
	<cffunction name="init" returntype="any">
		...
		<cfargument name="appleCertificatePath" type="string" required="false" default="#ExpandPath('apns/apn_sandbox.p12')#"/>
		<cfargument name="appleCertificatePassword" type="string" required="false" default="NUgget38!@"/>
	...
	<cffunction name="sendMessageToApple" returntype="void">
		...
		<cfset spacelesstoken = replace(arguments.token, " ", "", "all") />
		<cfhttp method="get" url="http://localhost/CFTestTrack/pushnotification.php?token=#spacelesstoken#&message=#arguments.message#" />
