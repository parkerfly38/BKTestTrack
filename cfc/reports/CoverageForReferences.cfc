component implements="COGTestTrack.cfc.IReports"
{
	...
	public CoverageForReferences function init(required numeric reportid, required string reportname, required struct reportoptions, required struct accessandscheduling) {
	...
	public struct function getReportOptions()
	{
		if ( structIsEmpty(variables.ReportOptions) ) {
			...
			variables.ReportOptions.References = "";
		}
