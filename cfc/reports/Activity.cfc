component implements="CFTestTrack.cfc.IReports"
{
	...
	public any function runReport() {
		...
		if ( variables.AccessAndScheduling.Email.NotifyMe gt 0) {
			...
			emailbody = "<h1>" & variables.ReportName & "</h1><p>Your report is available <a href='http://" & Application.HttpsUrl & "/" & Application.applicationname & "/reportpdfs/" & variables.reportid & ".pdf'>here</a>.</p>";
