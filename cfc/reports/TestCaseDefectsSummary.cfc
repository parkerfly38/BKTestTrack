component implements="CFTestTrack.cfc.IReports" 
{
    ...
    {
        return "Defects Summary for Test Cases";
    }
    ...
    {
        return "Highlights test case defect summary for selected date range.";
    }
	...
	public any function runReport()
    {
		...
		objData = createObject("component","CFTestTrack.cfc.Data");
		rs1 = objData.qryTestCaseDefectsSummary(variables.projectid); //Session.ProjectID,datestart,dateend);
		reportoutput = "<h3>Test Cases Defect Summary</h3><table class='table table-condensed table-striped'><thead><tr><th>Test Title</th><th>Action</th><th>Date Tested</th><th>Defects</th><th>Elapsed Time</th><th>Version</th><th>Tester</th><th>Test Scenario</th></tr></thead><tbody>";
		//for ( q in rs1 ) {
		for ( q = 1; q <= rs1.RecordCount; q++ ) {
            ...
            reportoutput &= "<tr><td>" & rs1.TestTitle[q] & "</td><td>" & rs1.Action[q] & "</td><td>" & rs1.DateTested[q] & "</td><td>" & rs1.Defects[q] & "</td><td>" & rs1.ElapsedTime[q] & "</td><td>" & rs1.Version[q] & "</td><td>" & rs1.UserName[q] & "</td><td>" & rs1.TestScenario[q] & "</td></tr>";
        }
